...
files.forEach(file => {
  ...
  // 1. Remove console.log (basic regex)
  ...
  content = content.replace(/\((err|error|e|res|response|data|event)\s*:\s*any\)/g, '($1: unknown)');

  // 4. Replace other obvious ': any' with ': unknown' where safe (e.g. Array<any> -> Array<unknown>)
