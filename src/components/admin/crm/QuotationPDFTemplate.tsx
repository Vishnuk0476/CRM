        ...
        <div className="p-8">
          ...
          <div className="text-xs mb-6 space-y-3 leading-relaxed text-slate-800">
            ...
            {data.scope_intro_text ? (
              <div 
                className="whitespace-pre-wrap [&>p]:mb-2 [&>ul]:list-disc [&>ul]:ml-5 [&>ul]:mb-2 [&>ol]:list-decimal [&>ol]:ml-5 [&>ol]:mb-2 [&_li]:mb-1"
                dangerouslySetInnerHTML={{ __html: data.scope_intro_text }} 
              />
            ) : (
              <p>
          ...
          <div className="mb-8">
            ...
            {data.terms_and_conditions ? (
              <div 
                className="text-[10px] text-slate-600 leading-relaxed text-justify [&>p]:mb-1.5 [&>ul]:list-disc [&>ul]:ml-4 [&>ul]:mb-1.5 [&>ol]:list-decimal [&>ol]:ml-4 [&>ol]:mb-1.5 [&_li]:mb-0.5"
